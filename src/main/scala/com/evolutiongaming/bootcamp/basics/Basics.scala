...
object Basics {
  ...
  // You can explicitly name values to use default values of other inputs
  def addNTimes2(x: Int, times: Int = 1, y: Int): Int = x + y * times

  val sum4 = addNTimes2(x = 2, y = 4) // 6, because 2 + 3 * 1
  ...
  val helloFunction: String => String = helloMethod(_)
  ...
  formatNamedValue[List[String]]("something", _.mkString(", "))(List("asdf", "qwer"))
  // Tuples
  //
  ...
  val allTupleBooleanBooleans: Set[(Boolean, Boolean)] = Set((true, true), (false, false), (false, true), (true, false))
